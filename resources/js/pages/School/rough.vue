...
/**
 * CourseSelectionStep - V3 (No Learning Types)
 * 
 * Changes:
 * - Removed learning type badges
 * - Single price display
 * - Show next batch preview
 * - All courses are live classes
 */
...
// Get next batch info for course
...
<template>
  <div class="space-y-6">
    ...
    <div class="text-center">
      <h2 class="text-2xl font-bold">Select Courses</h2>
