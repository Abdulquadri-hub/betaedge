...
import {
  Shield, Send, RefreshCw, AlertCircle,
...
import DocumentUploadCard from '@/components/Verification/Documentuploadcard.vue'
...
const userType = ref('instructor')   // 'instructor' | 'school'
...
async function handleSubmit() {
  ...
  try {
    ...
    verification.value.submitted_at = new Date().toISOString()
    uploadedFiles.value              = {}
    toast({ title: 'Documents submitted', description: 'We\'ll review them within 1–2 business days.' })
  } finally {
